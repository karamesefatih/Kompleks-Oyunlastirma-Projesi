...
namespace oyunlandırma
{
    public partial class Form33 : Form
    {
        ...
        void sayac()
        {
            ...
            baglan.Open();
            SqlCommand cmd = new SqlCommand("Select Count(*) from soru where Zorluk = 'orta'", baglan);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection baglan = new SqlConnection(bgl.Adres);
            baglan.Open(); ;
            SqlCommand komut = new SqlCommand("SELECT  top 1 * FROM soru where ZORLUK ='orta' ORDER BY NEWID() ", baglan);
        ...
        private void timer1_Tick(object sender, EventArgs e)
            {
                ...
                dogru = 0;
                    ...
                    if (label4.Text == "4")
                    {
                        ...
                        {
                            Form71 f47 = new Form71();
                            f47.label1.Text = label2.Text;
                            f47.label2.Text = label10.Text;
                            f47.label3.Text = label11.Text;
                            timer1.Stop();
                            f45.Show();
                            this.Hide();
