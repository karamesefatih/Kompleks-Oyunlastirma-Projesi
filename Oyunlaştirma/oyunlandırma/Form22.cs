...
namespace oyunlandırma
{
    public partial class Form22 : Form
    {
        ...
        void sayac()
        {
            SqlConnection baglan = new SqlConnection(bgl.Adres);
            baglan.Open();
            SqlCommand komut = new SqlCommand("select count(*) from Ürün_Bilgileri", baglan);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                komut1.CommandText = "INSERT INTO Ürün_Bilgileri(Ürün_Kodu,Adedi,Sınıfı,Puanı)VALUES('" + richTextBox1.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "UPDATE Ürün_Bilgileri Set Ürün_Kodu ='" + richTextBox1.Text + "',Adedi ='" + textBox1.Text + "',Sınıfı ='" + textBox2.Text + "',Puanı =" + textBox3.Text + " where  Kimlik=@NUMARA";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if(MessageBox.Show("Soru silinsin mi?", "SİSTEM", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk)==DialogResult.Yes)
                    ...
                    cmd2.CommandText = "DELETE FROM Ürün_Bilgileri WHERE Kimlik = @NUMARA";
                    cmd2.Parameters.AddWithValue("@NUMARA", dataGridView1.CurrentRow.Cells[0].Value.ToString());
                    cmd2.ExecuteNonQuery();
                    baglan.Close();
                    MessageBox.Show("Veri silindi", "SİSTEM", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand();
            cmd2.Connection = baglan;
            cmd2.CommandText = "DELETE FROM Ürün_Bilgileri ";
            cmd2.ExecuteNonQuery();
            baglan.Close();
